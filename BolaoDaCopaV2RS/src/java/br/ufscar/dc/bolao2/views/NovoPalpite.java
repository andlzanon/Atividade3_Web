...
public class NovoPalpite implements Serializable {
    ...
    private void recomecar() {
        ...
        mensagem.setMensagem(true, "Digite seu e-mail para dar início",
    ...
    public void procurarEmail() {
        ...
        try {
            usuarioEncontrado
                    = usuarioDao.buscarUsuarioPeloEmail(dadosPalpite.getPalpiteiro().getEmail());
...
estado = NovoPalpiteMaquinaEstados.usuarioExistente();
    ...
    public void conferirSenha() {
        ...
        if (senha.equals(usuarioEncontrado.getSenha())) {
            ...
            mensagem.setMensagem(true, "Senha correta! Informe seu palpite!",
                    MensagemBootstrap.TipoMensagem.TIPO_SUCESSO);
            estado = NovoPalpiteMaquinaEstados.usuarioExistenteSenhaCorreta();
        } else {
            estado = NovoPalpiteMaquinaEstados.usuarioExistente();
            mensagem.setMensagem(true, "Senha incorreta! Informe novamente!",
                    MensagemBootstrap.TipoMensagem.TIPO_ERRO);
        }
    }
