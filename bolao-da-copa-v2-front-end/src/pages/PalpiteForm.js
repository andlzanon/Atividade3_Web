...
class PalpiteForm extends React.Component {
    constructor() {
        ...
        this.handleChangeCampeao = this.handleChangeCampeao.bind(this);
   ...
   async handleConfirmarPalpiteClicked() {
    ...
    handleChangeCampeao(novoValor) {
        this.setState({campeao: novoValor.value});
    }

    handleChangeVice(novoValor) {
        this.setState({vice: novoValor.value});
    }

    async createSelect(){
        var selecoesParticipantesArray = [];
        try {
            const response = await fetch('http://localhost:8080/BolaoDaCopaV2RS/webresources/selecoesParticipantes');
            var contentType = response.headers.get("content-type");
            if (contentType && contentType.includes("application/json")) {
                selecoesParticipantesArray = await response.json();
            }
        } catch (e) {
            this.mostrarErro('Ocorreu um problema!');
            console.log(e);
        ...
        var items = [];
        for (let i = 0; i < selecoesParticipantesArray.length; i++) {
            var selecao = {value: selecoesParticipantesArray[i], 
                           label: selecoesParticipantesArray[i],
                        };
            items.push(selecao);   
        }
        this.setState({selecoesParticipantes: items});
        console.log(this.state.selecoesParticipantes);
    }
                    ...
                    <form className="form-horizontal" name="formPalpite">
                        ...
                        <div className="form-group">
                            ...
                            <div className="col-sm-4">
                                ...
                                <span className="text
                                    text-danger">{this.state.mensagensValidacao['email']}
                                </span>
                            ...
                            <div className="col-sm-4">
                                ...
                                <span className="text
                                    text-danger">{this.state.mensagensValidacao['senha']}
                                </span>
                            </div>
                        </div>
                        <div className="form-group">
                            ...
                            <div className="col-sm-10">
                                <input type="text"
                                    ...
                                    onChange={(event) => this.handleUserInput(event)}/>
                                <span className="text
                                    text-danger">{this.state.mensagensValidacao['nome']}
                                </span>
                            </div>
                        </div>
                        <div className="form-group">
                            ...
                            <div className="col-sm-4">
                                <input type="text"
                                    ...
                                    onChange={(event) => this.handleUserInput(event)}/>
                                <span className="text
                                    text-danger">{this.state.mensagensValidacao['telefone']}
                                </span>
                            </div>
                            ...
                            <div className="col-sm-3">
                                ...
                                <span className="text
                                    text-danger">{this.state.mensagensValidacao['dataDeNascimento']}
                                </span> 
                            </div>
                        </div>
                        ...
                        <div className={this.state.estado.camposDadosPalpiteDestaque ? 'form-group has-success' : 'form-group'}>
                            ...
                            <div className="col-sm-4">
                                <Select 
                                    ...
                                    onChange={this.handleChangeCampeao}
                                    clearable={false}
                                    options={this.state.selecoesParticipantes}/>
                                    <span className="text
                                        text-danger">{this.state.mensagensValidacao['campeao']}
                                    </span>
                            </div>
                            ...
                            <div className="col-sm-4">
                                ...
                                <span className="text
                                    text-danger">{this.state.mensagensValidacao['confirmarSenha']}
                                </span>
                            </div>
                        </div>
                        <div className={this.state.estado.camposDadosPalpiteDestaque ? 'form-group has-success' : 'form-group'}>
                            ...
                            <div className="col-sm-4">
                                <Select 
                                    ...
                                    options={this.state.selecoesParticipantes}/>
                                <span className="text
                                    text-danger">{this.state.mensagensValidacao['vice']}
                                </span>
                            </div>
